...
import { apiUrlSignupProvider, apiUrlEmailVerificationResend } from '../../../api'
...
class ProviderSignUp1 extends Component {
  ...
  render() {
    ...
    // if (redirect) {
    //   return <Navigate to="/provider-login1"></Navigate>
    // }
                  ...
                  <div className="btn-content" >
                    ...
                    <div>
                      <p className="submit-button">
                        <Link to="/provider-signup2">Continue with Mobile Number</Link>
                      </p>
                    </div>
                  </div>
                </div>
...
export default connect(mapStateToProps)(ProviderSignUp1)