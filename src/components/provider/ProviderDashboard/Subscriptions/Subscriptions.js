...
import { apiUrlProviderSubscriptions } from '../../../../api'
...
class ProviderSubscriptions extends Component {
  ...
  componentDidMount() {
    window.scrollTo(0, 0);
    axios.get(apiUrlProviderSubscriptions + '?nursery_id=' + this.props.nurseryId, { headers: { Authorization: 'Bearer ' + this.props.token } }).then(res => {
      this.setState({
        ...
        <section className="profile-container">
          ...
          <div className="profile-content">
            ...
            <div className="profile-nav-menu">
              <p>
                <Link to="/">Home</Link> / <Link to="/provider-subscriptions">
                  My Subscriptions
                </Link>
              </p>
            </div>
            ...
            <div className='d-flex justify-content-end'>
              <div class="archive">
                <Link to="/provider-subscriptions-archive">
...
export default connect(mapStateToProps)(ProviderSubscriptions)