...
class ProviderLogin2 extends Component {
  ...
  handleReducer = () => {
    ...
    axios.get(apiUrlCheckUserFirstTime, {}, { headers: {Authorization: 'Bearer ' + this.state.token} }).then(res => {
      this.setState({
                  ...
                  <div className="submit-buttons">
                    <div className="btn-content">
                      ...
                      <p className="submit-button">
                        <Link to='/provider-login1'>Continue with Email Address</Link>
                      </p>
                      </div>
                    </div>
                    {/* <div className="btn-content" >
                      <div>
                        <img src="../imgs/login1/Facebook.svg" alt="" /> 
                      </div>
                      <div>
                        <p className="submit-button">Continue with Facebook</p>
                      </div>
                    </div>
                    <div className="btn-content" >
                      <div>
                        <img src="../imgs/login1/Gmail.svg" alt="" />
                      </div>
                      <div>
                        <p className="submit-button">Continue with Google</p>
                      </div>
                    </div> */}
                  </div>
                </div>
...
export default connect(mapStateToProps)(ProviderLogin2)